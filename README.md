...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
  ...
  A relational database is the database software itself.  SQL is Structured Query Language and it is used to query the RDMS.

- [ ] Why do tables need a `primary key`?

  A primary key is needed because it is ensures the row can be accessed and is a unique value.  
